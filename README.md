...
**197 テスト** -- 2026-04-02 SIMPLEC連成 + BDF2時間積分 + Poiseuille検証 | 契約違反 **0件**（6プロセス） | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
|   +-- solver.py      # NaturalConvectionFDMProcess (SIMPLE/SIMPLEC + Boussinesq + BDF2)
