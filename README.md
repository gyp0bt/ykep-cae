...
**138 テスト** -- 2026-04-01 3D自然対流ソルバー (SIMPLE法+Boussinesq) + 固体-流体練成 | 契約違反 **0件**（6プロセス） | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
|   +-- strategies/    # Strategy Protocol 定義 + 具象スキーム（拡散/対流）
|   +-- docs/          # コアモジュール設計文書
...
|   +-- solver.py      # NaturalConvectionFDMProcess (SIMPLE + Boussinesq)
