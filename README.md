...
**267 テスト** -- 2026-04-21 AquariumGeometryProcess + HeaterProcess + 水槽ヒーター自然対流デモ（Phase 6.2a / 6.2b） | 契約違反 **0件**（10プロセス） | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
+-- aquarium/          # 水槽設計 CAE ドメイン（Phase 6.2）
