...
`xkep_cae_fluid/extruder/` の計算結果を、押出初心者向けに図解したページ群。
...
| 📚 **ゲート G5 — 文献 RTD 照合** | https://claude.ai/code/artifact/2b9bd8c5-6c35-4f7f-986f-dcf762ea43a9 | [g5-literature-rtd.md](g5-literature-rtd.md) / [html](g5-literature-rtd.html) | 粒子追跡の RTD を Pinto–Tadmor 1970 の解析曲線と照合。浅溝・長区間・小刻みの極限で収束する様子と、側壁・周回数・隙間・流線ドリフトのメカニズム |
...
`g5-literature-rtd.md` は `experiments/extruder/g5_literature.py`（粒子追跡 9 ケース、約 7 分、2 スレッド）と
`g5_report.py` で生成する。図はすべて inline SVG。
