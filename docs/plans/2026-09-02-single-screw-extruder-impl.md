...
**Phase 2 に入る前の前提は「実機データとの突き合わせ」だったが、実機データも
その想定も無いため、文献の解析 RTD（Pinto & Tadmor 1970）との照合 G5 に差し替えた**
（2026-09-04 通過。[設計](../design/extruder-g5-literature-rtd.md)、
[計画](2026-09-04-extruder-g5-literature-rtd.md)、[レポート](../reports/extruder/g5-literature-rtd.md)）。
